import { baseWorkoutLogbookApi } from 'src/store/baseWorkoutLogbookApi';

export * from 'src/store/baseWorkoutLogbookApi';

export const workoutLogbookApi = baseWorkoutLogbookApi.enhanceEndpoints({
    ...
    createExerciseRow: {
      onQueryStarted: async ({ workoutId, exerciseGroupId }, { dispatch, queryFulfilled }) => {
        queryFulfilled.then((result) => {
          dispatch(
            workoutLogbookApi.util.updateQueryData('getWorkout', { id: workoutId }, (draft) => {
